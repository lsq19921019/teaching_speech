...
<template>
    <div class="index">
        ...
        <div style="display:flex;margin-bottom:.5rem;">
            <div style="flex:3;display:flex;text-align:center;box-sizing:border-box;padding-left:5%;font-size:.44rem;color:#999999;">
                <div @click="tabSwitch" :class="tab_==1?'active_tab':''" style="flex:1;box-sizing:border-box;display:flex;justify-content: center;align-items: Center;">今日讲座</div>
                <div @click="tabSwitch" :class="tab_==2?'active_tab':''" style="flex:1;box-sizing:border-box;display:flex;justify-content: center;align-items: Center;">即将举办</div>
            </div>
            <div style="flex:2;overflow:hidden;padding-right:5%;">
                <div @click="toCalendar()" style="float:right;display:flex;justify-content: center;align-items: Center;height:100%;">
                    <img src="../assets/calendat_btn.png"/>
                </div> 
            </div>
        </div>
        <!-- 轮播图 -->
        ...
        <div v-if="tab_==1">
            <swiper v-if="bannerList.length > 1 && isShowSwiper" :options="swiperOption" ref="mySwiper">
                <swiper-slide v-for="(img,index) in bannerList" :key="index">
                    ...
                    <div style="width:90%;margin:0 auto;color:#999999;">
                        <div style="font-size:.32rem;color:#222222;font-weight:bold;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;width:100%;">
                            {{img.title}}
                        </div>
                        ...
                        <div @click="bannerLink()" style="margin:0 auto;margin-top:.3rem;width:100%;width:2.5rem;font-size:.3rem;background-color:#FF800E;text-align:center;color:#fff;padding:.2rem 0;padding-right:.35rem;border-radius:.4rem;">
                            点击查看详情
                            <img src="../assets/right_arrow.png" alt="" style="float:right;width:.3rem;margin-top:.14rem;"/>
                        </div>
                    </div>
                </swiper-slide>
            </swiper>
            <div v-else style="display:flex;justify-content: center;align-items: Center;height:8rem;">
                <div>
                    <img src="../assets/no_data.png" alt="">
                    <div style="margin-top: .2rem;color:#999999;">学校今日暂无讲座活动</div> 
                </div>
            </div>
        <!-- </div>     -->
        </div>
        <div v-else >
            <div v-if="bannerList_.length > 1">
                <div @click="bannerLink()" v-for="(img,index) in bannerList_" :key="index" style="display:flex;width:90%;margin:0 auto;border:1px solid #E5E5E5;margin-bottom:.2rem;">
...
<style lang="scss" scoped>
    .index{
        ...
        box-sizing: border-box;
            ...
            .active_tab{
                color: #222222;border-bottom: 5px solid #FF800E;
            }
            .swiper-slide{
                height:9rem;
